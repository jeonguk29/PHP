...
?>
			...
			<script language="javascript">
				...
				{
					window.open("zipcode.html?zip_kind="+zip_kind, "", "scrollbars=no,width=500,height=250");
				}
								...
								<td align="center">
									...
									<table border="0" cellpadding="0" cellspacing="0" width="635" class="cmfont">
										<tr>
											...
											<td>
												<input type="text" name="name" maxlength="10" value="<?=$row["name47"];?>" size="20" class="cmfont1">
											</td>
										</tr>
										<tr>
											<td width="127" height="30">
									...
									<table border="0" cellpadding="0" cellspacing="0" width="635" class="cmfont">
										...
										<tr>
											...
											<td>
												<input type="text" name='zip' size = "5" maxlength = "5" value = "<?=$row["zip47"];?>" class="cmfont1">
												<a href="javascript:FindZip(0)"><img align="absmiddle" src="images/b_zip.gif" border="0"></a><br>
												<input type="text" name='juso' size = "50" maxlength = "200" value = "<?=$row["juso47"];?>" class="cmfont1"><br>
											</td>
										</tr>
										<tr>
											<td width="127" height="50">
											...
											<td>
												<input type="text" name='email' size="50" maxlength="50" value="<?=$row["email47"];?>" class="cmfont1">
											</td>
										</tr>
										<tr><td colspan="2" height="10"></td></tr>
										<tr><td colspan="2" bgcolor="E6DDD5"></td></tr>
