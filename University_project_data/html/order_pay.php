			...
			<table width="710" border="0" cellpadding="0" cellspacing="0" class="cmfont">
				<tr>
					...
					<td align="center" width="470">
						...
						<table width="470" border="0" cellpadding="0" cellspacing="0" class="cmfont">
							<tr height="25">
								<td width="150"><font size=2 color="#000000"><b>결재방법 선택</b></font></td>
								<td width="20"><font size=2 color="#000000"><b>:</b></font></td>
								<td width="390">
									<input type="radio" name="pay_method" value="0" onclick="javascript:PaySel(0);" checked><font size=2 color="#000000">카드 </font>&nbsp;
									<input type="radio" name="pay_method" value="1" onclick="javascript:PaySel(1);"><font size=2 color="#000000">무통장</font>
								</td>
							</tr>
						</table>
			...
			<table width="710" border="0" cellpadding="0" cellspacing="0" class="cmfont">
				<tr>
					...
					<td align="center" width="470">
						<table width="470" border="0" cellpadding="0" cellspacing="0" class="cmfont">
							<tr height="25">
								<td width="150"><font size=2 color="#000000"><b>카드종류</b></td>
								<td width="20"><font size=2 color="#000000"><b>:</b></td>
								<td width="390">
							...
							<tr height="25">
								<td width="150"><font size=2 color="#000000"><b>카드번호</b></td>
								<td width="20"><font size=2 color="#000000"><b>:</b></td>
								<td width="390">
							...
							<tr height="25">
								<td width="150"><font size=2 color="#000000"><b>카드기간</b></td>
								<td width="20"><font size=2 color="#000000"><b>:</b></td>
								<td width="390">
							...
							<tr height="25">
								<td width="150"><font size=2 color="#000000"><b>카드비밀번호(뒷2자리)</b></td>
								<td width="20"><font size=2 color="#000000"><b>:</b></td>
								<td width="390">
							...
							<tr height="25">
								<td width="150"><font size=2 color="#000000"><b>할부</b></td>
								<td width="20"><font size=2 color="#000000"><b>:</b></td>
								<td width="390">
			...
			<table width="710" border="0" cellpadding="0" cellspacing="0" class="cmfont">
				<tr>
					...
					<td align="center" width="470">
						<table width="470" border="0" cellpadding="0" cellspacing="0" class="cmfont">
							<tr height="25">
								<td width="150"><font size=2 color="#000000"><b>은행선택</b></td>
								<td width="20"><font size=2 color="#000000"><b>:</b></td>
								<td width="390">
							...
							<tr height="25">
								<td width="150"><font size=2 color="#000000"><b>입금자 이름</b></td>
								<td width="20"><font size=2 color="#000000"><b>:</b></td>
								<td width="390">
