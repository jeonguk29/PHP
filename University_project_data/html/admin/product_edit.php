...
<table width="800" border="1" cellpadding="2" style="border-collapse:collapse">
   ...
   <tr> 
      ...
      <td width="700"  bgcolor="#F2F2F2">
         <textarea name="content" rows="4" cols="70"><?=$row["content47"]?></textarea>
      </td>
   </tr>
   <tr> 
            ...
            <tr>
               <td>
                  ...
                  <table width="390" border="0" cellspacing="0" cellpadding="0">
                     <tr>
                        <td  valign="middle">&nbsp;
                           <img src="../product/<?=$row["image1"]?>" width="47" height="47" border="1" style='cursor:hand' onclick="imageView('../product/<?=$row["image1"]?>')">&nbsp;
                           <img src="../product/<?=$row["image2"]?>" width="47" height="47" border="1" style='cursor:hand' onclick="imageView('../product/<?=$row["image2"]?>')">&nbsp;
                           <img src="../product/<?=$row["image3"]?>"  width="47" height="47" border="1" style='cursor:hand' onclick="imageView('../product/<?=$row["image3"]?>')">&nbsp;
                        </td>
                     </tr>             
                  </table>
               </td>
